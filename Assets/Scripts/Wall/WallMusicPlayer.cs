...
namespace MusicVR.Wall
{
	public class WallMusicPlayer : MonoBehaviour 
	{
		...
		void Awake()
		{
			...
			m_customSequencer = new ManualSequencer(Synth.Synth.Instance.midiStreamSynthesizer);
		}
		...
		public void Init(MusicWallData properties, WallButtonManager buttons, Synth.Synth synth)
		{
			m_data = properties;
